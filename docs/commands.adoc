...
== focus-zone
----
include::aerospace-focus-zone.adoc[tags=synopsis]
----
include::aerospace-focus-zone.adoc[tags=purpose]
include::aerospace-focus-zone.adoc[tags=body]
...
== move-floating-to-zone
----
include::aerospace-move-floating-to-zone.adoc[tags=synopsis]
----
include::aerospace-move-floating-to-zone.adoc[tags=purpose]
include::aerospace-move-floating-to-zone.adoc[tags=body]
...
== move-node-to-zone
----
include::aerospace-move-node-to-zone.adoc[tags=synopsis]
----
include::aerospace-move-node-to-zone.adoc[tags=purpose]
include::aerospace-move-node-to-zone.adoc[tags=body]

== zone-focus-mode
----
include::aerospace-zone-focus-mode.adoc[tags=synopsis]
----
include::aerospace-zone-focus-mode.adoc[tags=purpose]
include::aerospace-zone-focus-mode.adoc[tags=body]

== zone-preset
----
include::aerospace-zone-preset.adoc[tags=synopsis]
----
include::aerospace-zone-preset.adoc[tags=purpose]
include::aerospace-zone-preset.adoc[tags=body]
...
== meeting-mode
----
include::aerospace-meeting-mode.adoc[tags=synopsis]
----
include::aerospace-meeting-mode.adoc[tags=purpose]
include::aerospace-meeting-mode.adoc[tags=body]
...
== workspace-snapshot
----
include::aerospace-workspace-snapshot.adoc[tags=synopsis]
----
include::aerospace-workspace-snapshot.adoc[tags=purpose]
include::aerospace-workspace-snapshot.adoc[tags=body]
...
=== list-zones
----
include::aerospace-list-zones.adoc[tags=synopsis]
----
include::aerospace-list-zones.adoc[tags=purpose]
include::aerospace-list-zones.adoc[tags=body]
...
=== zone
----
include::aerospace-zone.adoc[tags=synopsis]
----
include::aerospace-zone.adoc[tags=purpose]
include::aerospace-zone.adoc[tags=body]

=== zone-memory
----
include::aerospace-zone-memory.adoc[tags=synopsis]
----
include::aerospace-zone-memory.adoc[tags=purpose]
include::aerospace-zone-memory.adoc[tags=body]

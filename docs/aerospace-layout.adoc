...
* Change tiling layout but preserve orientation: `tiles|accordion|stack`
...
* Toggle between `tiles` and `stack` layouts (order of args doesn't matter): +
`aerospace layout tiles stack`
